            ...
            <aside className="flex flex-col gap-6 lg:col-span-5">
              <div className="card-soft border border-ink/8 bg-pink p-6 sm:p-8">
                ...
                <a
                  ...
                  className="mt-2 block break-all font-display text-xl font-semibold hover:text-coral sm:text-2xl"
                >
                  {CONTACT_EMAIL}
                </a>
                ...
                <div className="mt-5 flex flex-wrap gap-4 text-[0.72rem] font-semibold uppercase tracking-[0.16em] text-ink-mute">
                  {SOCIAL.map((s) => (
                    <a
                      key={s.label}
                      href={s.href}
