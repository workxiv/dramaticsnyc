...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-inverse text-inverse-fg">
      ...
      <div className="mx-auto max-w-[1440px] px-5 py-20 text-center sm:px-8 sm:py-28 lg:px-12">
        ...
        <Reveal delay={0.1}>
          <div className="mt-9 flex flex-wrap items-center justify-center gap-4">
            ...
            <a
              href="#salons"
              className="rounded-full border-[1.5px] border-inverse-fg/40 px-9 py-4 text-[0.95rem] font-semibold text-inverse-fg transition-colors hover:border-inverse-fg hover:bg-inverse-fg hover:text-inverse"
            >
              Find Your Salon
            </a>
          </div>
      ...
      {/* Footer grid */}
      <div className="border-t border-inverse-fg/10">
        <div className="mx-auto grid max-w-[1440px] gap-12 px-5 py-14 sm:px-8 lg:grid-cols-12 lg:px-12">
          <div className="lg:col-span-4">
            <BrandLogo variant="onDark" className="h-7 w-auto sm:h-8" />
            <p className="mt-4 max-w-xs text-sm text-inverse-fg/60">
          ...
          <div className="lg:col-span-2">
            <p className="text-[0.72rem] font-semibold uppercase tracking-[0.18em] text-inverse-fg/50">
              Explore
            </p>
            ...
            <div className="mt-4 grid gap-x-8 gap-y-4 sm:grid-cols-2">
              {LOCATIONS.map((l) => (
                <div key={l.id} className="text-sm">
                  <p className="text-inverse-fg">{l.street}</p>
        ...
        <div className="mx-auto flex max-w-[1440px] flex-col items-start justify-between gap-3 border-t border-inverse-fg/10 px-5 py-6 text-[0.7rem] uppercase tracking-[0.12em] text-inverse-fg/40 sm:flex-row sm:items-center sm:px-8 lg:px-12">
